...
class LoginSerializer(serializers.Serializer):
    ...
    def get_auth_user_using_allauth(self, username, email, password):
        ...
        if allauth_account_settings.LOGIN_METHODS == allauth_account_settings.AuthenticationMethod.EMAIL:
            return self._validate_email(email, password)

        # Authentication through username
        if allauth_account_settings.LOGIN_METHODS == allauth_account_settings.AuthenticationMethod.USERNAME:
