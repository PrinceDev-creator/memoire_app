...
class GLUseKEK(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.DefaultedNamedType('glAcademy ',
            GLAcademy ().subtype(value=1)),
...
class GLRekey(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType('glName', GeneralName()),
        namedtype.OptionalNamedType('glAcademy ', GLAcademy ()),
...
class GLOwnerAcademy (univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType('glName', GeneralName()),
...
_cmcControlAttributesMapUpdate = {
    ...
    id_skd_glAddOwner: GLOwnerAcademy (),
    id_skd_glRemoveOwner: GLOwnerAcademy (),
