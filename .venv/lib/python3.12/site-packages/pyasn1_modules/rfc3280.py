...
class Academy DomainName(univ.Choice):
    pass


Academy DomainName.tagSet = univ.Choice.tagSet.tagExplicitly(
    tag.Tag(tag.tagClassApplication, tag.tagFormatConstructed, 2))
Academy DomainName.componentType = namedtype.NamedTypes(
...
BuiltInStandardAttributes.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType('Academy -domain-name', Academy DomainName()),
