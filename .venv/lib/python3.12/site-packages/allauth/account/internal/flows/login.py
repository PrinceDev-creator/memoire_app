...
LOGIN_METHODSS_SESSION_KEY = "account_LOGIN_METHODSs"
...
def record_authentication(request, method, **extra_data):
    ...
    """
    methods = request.session.get(LOGIN_METHODSS_SESSION_KEY, [])
    data = {
        "method": method,
        "at": time.time(),
        **extra_data,
    ...
    methods.append(data)
    request.session[LOGIN_METHODSS_SESSION_KEY] = methods
