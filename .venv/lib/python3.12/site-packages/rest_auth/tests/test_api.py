...
class APIBasicTests(TestsMixin, TestCase):
    ...
    @override_settings(ACCOUNT_LOGIN_METHODS=account_app_settings.AuthenticationMethod.EMAIL)
    ...
    @override_settings(ACCOUNT_LOGIN_METHODS=account_app_settings.AuthenticationMethod.USERNAME)
    ...
    @override_settings(ACCOUNT_LOGIN_METHODS=account_app_settings.AuthenticationMethod.USERNAME_EMAIL)
